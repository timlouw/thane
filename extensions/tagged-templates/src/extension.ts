...
const HTML_ELEMENTS = [
	...
	'select', 'option', 'textarea', 'details', 'summary', 'dialog',
	'slot', 'template', 'style', 'script', 'link', 'meta',
	'br', 'hr', 'pre', 'code', 'blockquote', 'strong', 'em',
];
...
const HTML_ATTRIBUTES = [
	'id', 'class', 'style', 'title', 'hidden', 'tabindex', 'role',
	'aria-label', 'aria-hidden', 'aria-disabled', 'aria-expanded',
	'data-', 'src', 'href', 'alt', 'type', 'name', 'value', 'placeholder',
	'disabled', 'checked', 'readonly', 'required', 'autofocus',
	'min', 'max', 'step', 'pattern', 'action', 'method', 'target',
	'width', 'height', 'for', 'rel',
];
...
const CSS_PROPERTIES = [
	...
	'grid-auto-columns', 'grid-auto-rows', 'place-items', 'place-content', 'place-self',
	...
	// Effects
	'opacity', 'box-shadow', 'text-shadow', 'outline', 'outline-offset',
	...
	// Misc
	'content', 'list-style', 'list-style-type', 'table-layout',
	'resize', 'appearance', 'scroll-behavior', 'object-fit', 'object-position',
	'aspect-ratio', 'container-type', 'container-name',
];
...
const CSS_VALUE_MAP: Record<string, string[]> = {
	...
	cursor: ['auto', 'default', 'pointer', 'move', 'text', 'wait', 'help', 'not-allowed', 'crosshair', 'grab', 'grabbing'],
...
const CSS_PSEUDO_SELECTORS = [
	...
	':not()', ':is()', ':where()', ':has()',
	':focus-visible', ':focus-within', ':empty', ':disabled', ':enabled',
