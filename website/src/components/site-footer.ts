...
export const SiteFooter = defineComponent('site-footer', () => ({
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <a href="https://github.com/timlouw/thane/issues" target="_blank" rel="noopener noreferrer" class="footer-link">
          ...
          <div class="footer-col">
            ...
            <a href="https://github.com/timlouw/thane/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" class="footer-link">MIT License</a>
            <a href="https://github.com/timlouw/thane" target="_blank" rel="noopener noreferrer" class="footer-link">Source Code</a>
          </div>
        </div>
        ...
        <div class="footer-bottom">
          ...
          <div class="footer-badges">
            <a href="https://www.npmjs.com/package/thane" target="_blank" rel="noopener noreferrer" class="footer-badge-link">
              <img src="https://img.shields.io/npm/v/thane?style=flat-square&color=cb3837&label=npm" alt="npm version" width="80" height="20" loading="lazy" />
            </a>
            <a href="https://github.com/timlouw/thane" target="_blank" rel="noopener noreferrer" class="footer-badge-link">
              <img src="https://img.shields.io/github/license/timlouw/thane?style=flat-square&color=blue" alt="license" width="80" height="20" loading="lazy" />
            </a>
          </div>
        </div>
      </div>
  ...
  styles: css`
    ...
    .footer-copy { color: var(--text-muted); font-size: 13px; margin-top: 8px; }
